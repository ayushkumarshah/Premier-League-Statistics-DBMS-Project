...
--
-- Host: localhost
-- Generation Time: Aug 05, 2017 at 01:24 AM
...
create database epl_normalized;
use epl_normalized;
...
--
ALTER TABLE `attacking_output_player`
  ADD CONSTRAINT `attack_players` FOREIGN KEY (`Player_id`) REFERENCES `player` (`Player_id`),
  ADD CONSTRAINT `attackoutput_attack` FOREIGN KEY (`Attack_id`) REFERENCES `attacking_output` (`Attack_id`);

--
-- Constraints for table `fouls_player`
--
ALTER TABLE `fouls_player`
  ADD CONSTRAINT `foulsplayer_fouls` FOREIGN KEY (`Fouls_id`) REFERENCES `fouls` (`Fouls_id`),
...
--
ALTER TABLE `fouls_team`
  ADD CONSTRAINT `foulsteam_fouls` FOREIGN KEY (`Fouls_id`) REFERENCES `fouls` (`Fouls_id`),
  ADD CONSTRAINT `teams_foulTeams` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);

--
-- Constraints for table `goals_team`
--
ALTER TABLE `goals_team`
  ADD CONSTRAINT `goalsteam_goals` FOREIGN KEY (`Goals_id`) REFERENCES `goals` (`Goals_id`),
...
--
ALTER TABLE `passing_player`
  ADD CONSTRAINT `players_playerspassing` FOREIGN KEY (`Player_id`) REFERENCES `player` (`Player_id`);

--
-- Constraints for table `passing_team`
--
ALTER TABLE `passing_team`
  ADD CONSTRAINT `teams_teamspassing` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);
...
--
ALTER TABLE `player_info`
  ADD CONSTRAINT `Playername_team` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);

--
-- Constraints for table `points_away`
--
ALTER TABLE `points_away`
  ADD CONSTRAINT `pointsaway_points` FOREIGN KEY (`Points_id`) REFERENCES `points` (`Points_id`),
  ADD CONSTRAINT `team_points_away` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);

--
-- Constraints for table `points_home`
--
ALTER TABLE `points_home`
  ADD CONSTRAINT `pointshome_points` FOREIGN KEY (`Points_id`) REFERENCES `points` (`Points_id`),
  ADD CONSTRAINT `team_points_home` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);
...
ALTER TABLE `revenues`
  ...
  ADD CONSTRAINT `revenues_total` FOREIGN KEY (`Total_id`) REFERENCES `total_revenues` (`Total_id`);

--
-- Constraints for table `set_pieces_team`
--
ALTER TABLE `set_pieces_team`
  ADD CONSTRAINT `teams_setpieces` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);

--
-- Constraints for table `shots_team`
--
ALTER TABLE `shots_team`
  ADD CONSTRAINT `team_accuracy` FOREIGN KEY (`Accuracy_id`) REFERENCES `shots_accuracy` (`Accuracy_id`),
  ADD CONSTRAINT `team_shots` FOREIGN KEY (`Club_id`) REFERENCES `team` (`Club_id`);

--
-- Constraints for table `standings`
--
ALTER TABLE `standings`
  ADD CONSTRAINT `standings_points` FOREIGN KEY (`Standings`) REFERENCES `standingspoints` (`Standings`),
...
--
ALTER TABLE `team`
  ADD CONSTRAINT `Team_teamname` FOREIGN KEY (`Club_name`) REFERENCES `team_info` (`Club_name`);
